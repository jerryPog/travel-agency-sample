    ...
    <div className="fixed bottom-6 right-6 z-50 font-['DM_Sans',sans-serif]">
      ...
      {isOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="WhatsApp Paris Travel Concierge Chat"
          className="absolute bottom-16 right-0 w-80 bg-[#0B132B]/95 backdrop-blur-2xl border border-white/20 rounded-3xl shadow-2xl p-5 text-white animate-in fade-in slide-in-from-bottom-4 duration-300"
        >
          <div className="flex items-center justify-between border-b border-white/10 pb-3 mb-3">
            <div className="flex items-center space-x-2.5">
              <div className="relative">
                ...
                <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-emerald-400 border-2 border-[#0B132B] rounded-full" aria-hidden="true" />
              </div>
              <div>
      ...
      <button
        ...
        aria-label="Open WhatsApp Chat with Local Paris Guide"
