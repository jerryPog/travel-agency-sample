...
export function FooterNav() {
  ...
  return (
    <footer className="w-full bg-[#070B14] border-t border-gradient-gold text-white font-['DM_Sans',sans-serif] relative z-20 pt-12 pb-8 px-4 sm:px-6 md:px-12">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
        {/* Col 1: Brand Info */}
        <div className="md:col-span-5 space-y-4">
          <Link to="/" className="text-2xl sm:text-3xl font-bold font-serif-editorial text-gold-gradient tracking-wider block">
          ...
          <div className="flex items-center space-x-2 text-xs text-amber-300 font-mono">
            ...
            <span>24/7 VIP Paris Concierge & Private Jet Services</span>
          </div>
        </div>

        {/* Col 2: Quick Links */}
        <div className="md:col-span-3 space-y-3">
          <h4 className="text-xs font-bold font-mono text-amber-300/80 uppercase tracking-widest">
            Navigation
          </h4>
